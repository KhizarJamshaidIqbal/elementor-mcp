...
<div class="elementor-mcp-connection">
	...
	<div class="elementor-mcp-section">
		...
		<p class="description">
			<?php esc_html_e( 'Unauthenticated requests to this MCP endpoint are expected to return 401 Unauthorized. Use a WordPress username plus an Application Password when connecting an MCP client.', 'elementor-mcp' ); ?>
		</p>
	</div>
